        ...
        objectCall.enqueue(new Callback<Data>() {
            ...
            public void onResponse(Call<Data> call, Response<Data> response) {
                if (response.isSuccessful()) {
                    ...
                    DDDDb.getInstance(FacilityActivation.this).facilityRepository().delete3();
                    DDDDb.getInstance(FacilityActivation.this).facilityRepository().delete4();
                    DDDDb.getInstance(FacilityActivation.this).facilityRepository().delete5();
                    DDDDb.getInstance(FacilityActivation.this).facilityRepository().delete6();
                    Intent streamPlayerHome = new Intent(getApplicationContext(), FacilityHome.class);
                    startActivity(streamPlayerHome);
                    finish();
