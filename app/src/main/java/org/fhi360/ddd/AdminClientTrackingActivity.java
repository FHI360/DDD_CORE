...
public class AdminClientTrackingActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    private int id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), AdminDefaulterListActivity.class);
        ...
        try {
            dateLastVisit = new SimpleDateFormat("MM-dd-yyyy").parse(encounter.getDateStarted());
            dateNextVisit = new SimpleDateFormat("MM-dd-yyyy").parse(encounter.getDateNextRefill());
    ...
    public void onClickSaveButton(View view) {
        dateTracked = DateUtil.parseStringToDate(((EditText) findViewById(R.id.date_tracked)).getText().toString(), "MM-dd-yyyy");
        ...
        dateAgreed = DateUtil.parseStringToDate(((EditText) findViewById(R.id.date_agreed)).getText().toString(), "MM-dd-yyyy");
    ...
    private void savePreferences() {
        ...
        editor.putString("dateTracked", DateUtil.parseDateToString(dateTracked, "MM-dd-yyyy"));
        editor.putString("typeTracking", typeTracking);
        editor.putString("trackingOutcome", trackingOutcome);
        editor.putString("dateAgreed", DateUtil.parseDateToString(dateAgreed, "MM-dd-yyyy"));
        editor.putString("dateLastVisit", DateUtil.parseDateToString(dateLastVisit, "MM-dd-yyyy"));
        editor.putString("dateNextVisit", DateUtil.parseDateToString(dateNextVisit, "MM-dd-yyyy"));
        editor.commit();
    }
    ...
    private void restorePreferences() {
        ...
        dateTracked = DateUtil.parseStringToDate(Objects.requireNonNull(preferences.getString("dateTracked", "")), "MM-dd-yyyy");
        typeTracking = preferences.getString("typeTracking", "");
        trackingOutcome = preferences.getString("trackingOutcome", "");
        dateAgreed = DateUtil.parseStringToDate(Objects.requireNonNull(preferences.getString("dateAgreed", "")), "MM-dd-yyyy");
        dateLastVisit = DateUtil.parseStringToDate(Objects.requireNonNull(preferences.getString("dateLastVisit", "")), "MM-dd-yyyy");
        dateNextVisit = DateUtil.parseStringToDate(Objects.requireNonNull(preferences.getString("dateNextVisit", "")), "MM-dd-yyyy");

        EditText editText = (EditText) findViewById(R.id.date_tracked);
        editText.setText(DateUtil.parseDateToString(dateTracked, "MM-dd-yyyy"));
        ...
        editText.setText(DateUtil.parseDateToString(dateAgreed, "MM-dd-yyyy"));
    }
