...
import org.fhi360.ddd.AdminRountingReportingPeriod;
...
public class RountineAdapterAdmin extends PagerAdapter implements CardAdapter {
        ...
        if (position == 0) {
            ...
            assigined.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(context, AdminRountingReportingPeriod.class);
