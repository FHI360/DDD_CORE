...
public class PatientRecyclerAdapter5 extends RecyclerView.Adapter<PatientRecyclerAdapter5.ViewHolder> {
    ...
    public PatientRecyclerAdapter5(List<Patient> patientList, Context context) {
    ...
    @NonNull
    @Override
    public PatientRecyclerAdapter5.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        try {
            ...
            dateRegistration.setText(finalString);
        } catch (Exception e) {
          ...
          //  dateRegistration.setText((CharSequence) date1);
            ...
            Pharmacy pharmacy = DDDDb.getInstance(context).pharmacistAccountRepository().findById(patientList.get(position).getPharmacyId());
            facilityView.setText(pharmacy.getName());
