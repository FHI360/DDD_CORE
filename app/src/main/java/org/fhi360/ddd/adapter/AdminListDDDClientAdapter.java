...
import org.fhi360.ddd.AdminListDDDProfileActivity;
...
public class AdminListDDDClientAdapter extends RecyclerView.Adapter<AdminListDDDClientAdapter.ViewHolder> {
    ...
    public AdminListDDDClientAdapter(List<Pharmacy> accountList, Context context) {
    ...
    @NonNull
    @Override
    public AdminListDDDClientAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        CardView cardView = (CardView) LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_ddd_list_clients2, parent, false);
        return new AdminListDDDClientAdapter.ViewHolder(cardView);
    }
    ...
    @Override
    public void onBindViewHolder(AdminListDDDClientAdapter.ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        TextView numberOfClients = cardView.findViewById(R.id.numberofclient);
        int count = DDDDb.getInstance(context).patientRepository().count(accountList.get(position).getId());
        numberOfClients.setText("Clients Num: " + count);
        TextView dateRegistration = cardView.findViewById(R.id.dateText);
        Date date1 = null;
        try {
            date1 = new SimpleDateFormat("MM/dd/yyyy").parse(accountList.get(position).getDateRegistration());
        ...
        dateRegistration.setText(form.format(date1));
        //dateRegistration.setText((CharSequence) date1);
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, AdminListDDDProfileActivity.class);
