    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.delete:
                ...
                return true;
            case R.id.view:
                Intent intent = new Intent(AdminListDDDProfileActivity.this, AdminListClientNumber.class);
...
//    }
    ...
    private void showAlertDelete() {
        ...
        notitoptxt.setText("Are you sure you want to deactivate this Oulet ?");
